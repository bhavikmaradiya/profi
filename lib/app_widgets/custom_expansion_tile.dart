...
class CustomExpansionTileController {
  ...
  CustomExpansionTileState? _state;
  ...
  static CustomExpansionTileController of(BuildContext context) {
    final CustomExpansionTileState? result =
        context.findAncestorStateOfType<CustomExpansionTileState>();
    if (result != null) {
      return result._tileController;
    }
    throw FlutterError.fromParts(<DiagnosticsNode>[
      ErrorSummary(
        'CustomExpansionTileController.of() called with a context that does not contain a ExpansionTile.',
      ),
      ErrorDescription(
        'No ExpansionTile ancestor could be found starting from the context that was passed to CustomExpansionTileController.of(). '
  ...
  static CustomExpansionTileController? maybeOf(BuildContext context) {
    return context
        .findAncestorStateOfType<CustomExpansionTileState>()
        ?._tileController;
  }
}
