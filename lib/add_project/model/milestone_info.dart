...
class MilestoneInfo {
  ...
  factory MilestoneInfo.fromSnapshot(DocumentSnapshot document) {
    ...
    return MilestoneInfo(
      ...
      lastMilestoneDate: data[FireStoreConfig.lastMilestoneDate],
      milestoneAmount: data[FireStoreConfig.milestoneAmountField],
      lastMilestoneAmount: data[FireStoreConfig.lastMilestoneAmount],
  ...
  factory MilestoneInfo.copy(MilestoneInfo info) {
    return MilestoneInfo(
      ...
      lastMilestoneDate: info.lastMilestoneDate,
      milestoneAmount: info.milestoneAmount,
      lastMilestoneAmount: info.lastMilestoneAmount,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      FireStoreConfig.lastMilestoneAmount: lastMilestoneAmount,
      FireStoreConfig.lastMilestoneDate: lastMilestoneDate,
    };
  }
}
