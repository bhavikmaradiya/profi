...
class GenerateBDMListEvent extends AddProjectFieldEvent {}

class GeneratePMListEvent extends AddProjectFieldEvent {}
...
class BdmInfoSelectionChangeEvent extends AddProjectFieldEvent {
  final DropDownModel bdmInfo;

  BdmInfoSelectionChangeEvent(this.bdmInfo);
}

class ProjectManagerInfoSelectionChangeEvent extends AddProjectFieldEvent {
  final DropDownModel pmInfo;

  ProjectManagerInfoSelectionChangeEvent(this.pmInfo);
}
