...
class MilestoneOperationsBloc
  ...
  _updateMilestoneInvoicedStatus(
    ...
    final milestoneData = {
      ...
      FireStoreConfig.milestoneInvoicedUpdatedAtField: currentTime,
      FireStoreConfig.updatedAtField: currentTime,
    };
    ...
    final transactionInfo = TransactionInfo(
      ...
      milestoneAmount: milestoneInfo.milestoneAmount,
      milestoneDate: milestoneInfo.dateTime?.millisecondsSinceEpoch,
      transactionType: (isInvoiced
              ? TransactionTypeEnum.invoiced
              : TransactionTypeEnum.unInvoiced)
          .name,
  ...
  Map<String, dynamic> _createMilestoneData(
    ...
    milestoneData[FireStoreConfig.lastMilestoneDate] =
        milestoneInfo.dateTime?.millisecondsSinceEpoch;
  ...
  _onUpdateTransaction(
    ...
    if (milestoneInfo != null) {
      ...
      final isUpdated = (oldDate != newDate || oldAmount != newAmount);
      ...
      //Add transactions for edited milestone
      if (isUpdated) {
        final prefs = await SharedPreferences.getInstance();
        final List<String> availableForList = [];
        if (projectInfo.bdmUserId != null) {
      ...
      final milestoneData = _createMilestoneDataToUpdate(
        ...
        milestoneInfo: milestoneInfo
          ...
          ..lastMilestoneDate =
              isUpdated ? oldDate : milestoneInfo.lastMilestoneDate
          ..lastMilestoneAmount =
              isUpdated ? oldAmount : milestoneInfo.lastMilestoneAmount,
      );
  ...
  _addNewMilestone(
    ...
    if (MilestoneUtils.isValidMilestone(milestoneInfo)) {
      ...
      // create transaction on milestone create
      final transactionInfo = TransactionInfo(
        transactionId: _generateTransactionId(),
        projectId: projectInfo.projectId,
        projectName: projectInfo.projectName,
  ...
  Map<String, dynamic> _createMilestoneDataToUpdate({
    ...
    data[FireStoreConfig.lastMilestoneDate] = milestoneInfo.lastMilestoneDate;
    data[FireStoreConfig.milestoneNotesField] = notes;
    data[FireStoreConfig.milestoneAmountField] = updatedMilestoneAmount;
    data[FireStoreConfig.lastMilestoneAmount] =
        milestoneInfo.lastMilestoneAmount;
...
/*Future<QuerySnapshot> _queryToRetrieveTransactionDocsToUnPaid(
  ...
  TransactionInfo _createTransactionInfoForMultipleTransactions({
    ...
    return TransactionInfo(
      ...
      milestoneAmount: milestoneInfo.milestoneAmount,
      milestoneDate: milestoneInfo.milestoneDate?.millisecondsSinceEpoch,
      transactionType: isPaidTransaction
          ? TransactionTypeEnum.paid.name
          : TransactionTypeEnum.unpaid.name,
      paidAmount:
  ...
  Map<String, dynamic> _createMilestoneDataForMultipleTransactions({
    ...
    milestoneData[FireStoreConfig.lastMilestoneAmount] =
        milestoneInfo.milestoneAmount;
    milestoneData[FireStoreConfig.lastMilestoneDate] =
        milestoneInfo.milestoneDate?.millisecondsSinceEpoch;
    if ((milestoneInfo.milestoneAmount ?? 0) <= totalReceivedAmount) {
      milestoneData[FireStoreConfig.milestonePaymentStatusField] =
          PaymentStatusEnum.fullyPaid.name;
    } else {
